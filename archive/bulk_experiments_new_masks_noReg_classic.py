...
CKPT_ROOT = "./checkpoints_bulk_batchedIsing_new_masks_noReg_0.1_classic"

# CSV destination (append mode)
CSV_PATH  = "bulk_results_all_ising_batchedIsing_new_masks_noReg_0.1_classic.csv"
