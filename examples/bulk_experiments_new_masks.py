...
CKPT_ROOT = "./checkpoints_bulk_batchedIsing_new_masks"

# CSV destination (append mode)
CSV_PATH  = "bulk_results_all_ising_batchedIsing_new_masks.csv"
...
def build_args(dataset, ising_type, val_split, seed):
    ...
    base = dict(
        ...
        lambda_weight1    = 1e-6,
        lambda_weight2    = 1e-6,
        train_epochs      = 24,   # ← match your example if intended
        ising_epochs      = 5,
        addtl_ft          = 1,
