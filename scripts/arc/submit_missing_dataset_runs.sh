...
# Submit only the 24 Fashion-MNIST/CIFAR-10 reviewer-extension runs.
# Six array tasks each execute four configurations sequentially on one GPU.
...
job_id="${submission%%;*}"
echo "Submitted 24 missing-dataset runs as six packed tasks."
echo "Job ID: ${job_id}"
